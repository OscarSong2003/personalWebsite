    ...
    return (
        ...
        width="100%" minHeight="900px" marginTop="300px" paddingTop="150px" mb="100px">
             ...
             width="50%" marginLeft="2px" borderLeft="2px" borderLeftWidth="2px" pl={5} borderColor="whiteAlpha.700">
                <Text fontSize="22px" color="whiteAlpha.800">Software Engineer Intern (Machine Learning) @ Meta</Text>
                <Text mt={1} fontSize="20px" color="whiteAlpha.800">Menlo Park, California</Text>
                <Text mt={1} fontSize="20px" color="whiteAlpha.800">May 2025 - July 2025</Text>
                <Text my={5} fontSize="20px" color="whiteAlpha.800">
                - Built a gesture-based Stories view action model using swipe and right-click signals, and conducted offline and
                online analysis, increasing daily story views by 33M, top tray taps by 15M, and viewer sessions by 4M.
                </Text>
                <Text fontSize="20px" color="whiteAlpha.800">
                - Developed data pipelines that generated 2B training labels and trained a Facebook Stories creation model to
                predict user creation intent, resulting in a daily increase of 3.2M story card views and 1.5M story creations.
                </Text>
            </Flex>
             ...
             width="50%" marginLeft="2px" borderLeft="2px" borderLeftWidth="2px" pl={5} borderColor="whiteAlpha.700">
                ...
                <Text my={5} fontSize="20px" color="whiteAlpha.800">
                    - Introduced client and team facing dashboards to reflect core system performance metrics that involved billions of store transaction data for 60+ teams.
                </Text>
                <Text fontSize="20px" color="whiteAlpha.800">
                    - Developed a front-end user interface that facilitates the generation of JSON specifications used in internal machine learning pipelines 
                    and services used across buyer abuse engineering.
                </Text>
            </Flex>
